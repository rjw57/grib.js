...
exports.parseDataView = function(dataView) {
  var msgs = [], offset,
      binary = jBinary(dataView, {
        ...
        gribSigned: jBinary.Type({
          params: ['numberOfBits'],
          read: function () {
            const sign = this.binary.view.getUnsigned(1)
            const value = this.binary.view.getUnsigned(this.numberOfBits - 1)
            return (1 == sign) ? -value : value
          },
        }),
        grib32: ['gribSigned', 32],
        grib16: ['gribSigned', 16],
      }),
      indicator, sections;
...
var sectionParsers = {
  ...
  7: function(binary, section5) { // data
    ...
    if (3 == section5.contents.templateNumber.value) {
        ...
        // skip to next octet
        let mod = NG*nb%8
        mod != 0 && binary.view.getUnsigned(8-mod)
